...
import { useDrawStore, useDrawPointStore } from "../../stores";
import { TypeDraw } from "../../types";

function LeftControls() {
    const { isDrawDoor, isDrawWindow, setDraw, isDrawWall } = useDrawStore(state => state);
    const { resetWallDrawPoints } = useDrawPointStore();
    ...
    }, [isDrawDoor, isDrawWall, isDrawWindow, resetWallDrawPoints, setDraw]);
